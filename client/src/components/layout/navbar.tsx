...
export default function Navbar() {
  ...
  const navigation = [
    ...
    { name: "Fiches journalières", href: "/presences", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-700">Marie Kouassi</span>
              <div className="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center">
                <span className="text-sm font-medium text-primary-600">MK</span>
              </div>
            </div>
          </div>
        </div>
